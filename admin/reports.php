...
<style>.report-card,.toolbar{margin-bottom:18px;box-shadow:0 1px 2px rgba(16,24,40,.04)}.report-table thead th,.toolbar-field label{text-transform:uppercase;letter-spacing:.03em;font-weight:600}:root{--psa-blue:#003883;--psa-blue-dark:#002a63;--psa-red:#CE1126;--psa-orange:#F26522;--ink:#1c2430;--ink-soft:#5b6472;--line:#e3e7ee;--surface:#ffffff;--canvas:#f4f6f9}body{font-family:Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--ink);background-color:var(--canvas)}.print-header{display:none}.reports-shell{max-width:none;width:100%}.toolbar{background:var(--surface);border:1px solid var(--line);border-radius:10px;padding:14px 18px}.btn-psa-primary,.btn-psa-primary:hover{background-color:var(--psa-blue);color:#fff}.toolbar-field label{font-size:11px;color:var(--ink-soft);margin-bottom:4px;display:block}.form-control-sm,.form-select-sm{border-color:var(--line);font-size:13px;border-radius:6px}.form-control-sm:focus,.form-select-sm:focus{border-color:var(--psa-blue);box-shadow:0 0 0 3px rgba(0,56,131,.12)}.btn-psa-primary{border-color:var(--psa-blue);font-size:13px;font-weight:600;border-radius:6px}.btn-psa-primary:hover{border-color:var(--psa-blue)}.btn-psa-outline{border:1px solid var(--line);color:var(--ink-soft);font-size:13px;border-radius:6px;background:var(--surface)}.btn-psa-outline:hover{border-color:var(--psa-blue);color:var(--psa-blue)}.btn-psa-accent,.btn-psa-accent:hover{background-color:transparent;color:#000}.btn-psa-accent{border:1px solid #000;border-radius:6px;font-size:13px;font-weight:600;padding:0 16px;display:inline-flex;align-items:center;justify-content:center;flex-shrink:0}.active-filter-note,.metric-label{color:var(--ink-soft)}.btn-psa-accent:hover{border-color:#000}.report-card-header,.report-table tbody tr,.report-table thead th{border-bottom:1px solid var(--line)}.active-filter-note{font-size:12.5px}.metric-strip{display:flex;flex-wrap:wrap;align-items:center;gap:14px;padding:8px 10px}.metric-item{display:flex;align-items:baseline;gap:6px;font-size:10px}.metric-value{font-weight:700;font-size:11px;color:var(--ink)}.report-card{background:var(--surface);border:1px solid var(--line);border-radius:10px;overflow:hidden}.report-card-header{padding:10px 16px;display:flex;align-items:center;justify-content:space-between;gap:10px}.report-card-header-left{display:flex;align-items:center;gap:10px}.report-card-header .bar{width:4px;height:16px;border-radius:2px;background:var(--psa-blue)}.report-card-header h6{font-size:13.5px;font-weight:700;letter-spacing:.01em;color:var(--ink);margin:0}.table-scroll{overflow-x:auto}.report-table{width:auto;font-size:12px;border-collapse:collapse;margin:0}.report-table td,.report-table th{white-space:nowrap;text-align:center!important;padding:6px 10px}.report-table thead th{background:#f8f9fb;color:var(--ink-soft);font-size:11px;position:sticky;top:0}.report-table td:first-child,.report-table th:first-child{text-align:left!important;position:sticky;left:0;background:var(--surface);font-weight:600;z-index:1}.report-table thead th:first-child{background:#f8f9fb;z-index:2}.report-table tbody tr:hover td,.report-table tbody tr:hover td:first-child{background-color:#f5f8fc}.report-table tfoot td{font-weight:700;background:#f8f9fb;border-top:2px solid var(--line)}@media (min-width:1200px){.report-table:not(.report-table-compact){width:100%}}@media (max-width:768px){.report-table,.report-table thead th{font-size:8px}.report-table td,.report-table th{padding:3px 6px}}@media print{@page{size:landscape;margin:10mm}body{background:#fff}.crasm-navbar,.no-print{display:none!important}main{padding:0!important}.print-header{display:flex!important;align-items:center;gap:12px;border-bottom:2px solid var(--psa-blue);padding-bottom:10px;margin-bottom:16px}.report-card{border:1px solid #ccc;box-shadow:none;page-break-inside:avoid}.table-scroll{overflow:visible!important}.report-table{width:100%;table-layout:fixed;font-size:10px}.report-table thead th{font-size:9px}.report-table td,.report-table th{padding:4px 3px;white-space:normal;text-align:center!important}.report-table td:first-child,.report-table th:first-child{width:11%;text-align:left!important}.report-table td:last-child,.report-table td:nth-child(2),.report-table th:last-child,.report-table th:nth-child(2){width:6%}.report-table-compact{width:auto;table-layout:auto}.report-table-compact td,.report-table-compact th{width:auto!important}.report-table-compact td:first-child,.report-table-compact th:first-child{text-align:left!important}.report-card-compact{display:inline-block;width:auto}}</style>
